...
public class FindPasswordResetActivity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.find_password_reset_activity);
        ...
        Button btnFindPasswordReset = (Button) findViewById(R.id.btn_find_password_reset);
        btnFindPasswordReset.setOnClickListener(this);
    }
