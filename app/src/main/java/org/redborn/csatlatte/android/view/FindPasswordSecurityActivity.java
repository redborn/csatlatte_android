...
public class FindPasswordSecurityActivity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.find_password_security_activity);
        ...
        Button btnFindPasswordSecurity = (Button) findViewById(R.id.btn_find_password_security);
        btnFindPasswordSecurity.setOnClickListener(this);
    }
